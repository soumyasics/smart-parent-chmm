    ...
    <div>
      <div
        className={`tw-chat tw-chat-${
          message?.senderType === "vc" ? "start" : "end"
        }`}
      >
...
export function Message2({ message }) {
  console.log("message", message.senderType);

  
  return (
    <>
      <div className={`tw-chat tw-chat-${message?.senderType === "vc" ? "end" : "start"}`}>
        <div className="tw-chat-image tw-avatar">
          <div className="tw-w-10 tw-rounded-full">
            <img
              alt="Tailwind CSS chat bubble component"
